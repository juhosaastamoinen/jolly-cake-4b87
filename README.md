...
```
npm create cloudflare@latest -- --template=cloudflare/templates/jolly-cake-4b87
```

A live public deployment of this template is available at [https://jolly-cake-4b87.templates.workers.dev](https://jolly-cake-4b87.templates.workers.dev)
